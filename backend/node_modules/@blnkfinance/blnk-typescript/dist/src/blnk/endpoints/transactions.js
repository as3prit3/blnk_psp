...
class Transactions {
    ...
    createBulk(data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const validatorResponse = (0, transactionValidators_1.ValidateBulkTransactions)(data);
                if (validatorResponse) {
                    return this.formatResponse(400, validatorResponse, null);
                }
                const response = yield this.request(`transactions/bulk`, data, `POST`);
                if (response.data === null) {
                    // Handle the error case
                ...
                return (0, logger_1.HandleError)(error, this.logger, this.formatResponse, this.createBulk.name);
            }
        });
    }
}
